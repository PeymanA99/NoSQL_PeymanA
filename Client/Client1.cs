...
namespace Project4Starter
{
  ...
  class Client
  {
    ...
    static void Main(string[] args)
    {
      ...
      msg.eventType = "Built Failed Check build";
      msg.actionCode = "buildFailed";
      ...
      while (true)
      {
            msg.content = "Test-Harness Server Crashed!" + (++counter).ToString();
            msg.eventType = "Test-Harness_Failed";
            msg.actionCode = "outOfMemory";
            msg.whenOccured = DateTime.Now;

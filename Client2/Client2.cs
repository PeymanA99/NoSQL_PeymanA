...
namespace Project4Starter
{
  ...
  class Client
  {
    ...
    string remoteUrl { get; set; } = "http://localhost:8087/CommService";
    ...
    static void Main(string[] args)
    {
      ...
      msg.toUrl = "http://localhost:8079/CommService"; // here is always port 80
      msg.eventType = "Checked In";
      msg.whenOccured = DateTime.Now.AddSeconds(2);
      msg.content = "DBElement.cs Version 1.9 Checked Out" ;
      ...
      while (true)
      {
            msg = new Message();
            msg.fromUrl = clnt.localUrl;
            msg.toUrl = "http://localhost:8079/CommService";
            msg.eventType = "Check-out File";
            msg.actionCode = "checkout";
            msg.whenOccured = DateTime.Now;
            msg.content = "[Key] #" + (++counter).ToString();

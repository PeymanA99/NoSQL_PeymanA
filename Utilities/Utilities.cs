...
namespace Project4Starter
{
  static public class Utilities
  {
    ...
    static public string processCommandLineForLocal(string[] args, string localUrl)
    {
      ...
      static public Func<int, string> keyGen = (key) =>
      {
            ++key;
   ...
   static public string processCommandLineForRemote(string[] args, string remoteUrl)
    ...
    public static void showMessage(Message msg)
    {
      ...
      Console.Write("\n  msg.whenOccured:   {0}", msg.whenOccured.ToString("MM/dd/yyyy hh:mm:ss.fff tt"));
      Console.Write("\n  msg.eventType:   {0}", msg.eventType);
      Console.Write("\n  msg.actionCode:   {0}", msg.actionCode);

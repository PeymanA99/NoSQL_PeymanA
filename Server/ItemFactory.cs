...
namespace Project4Starter
{
  ...
  public class ItemFactory<Key, Data> where Data : class, IClone, IPersist, new()
  {
    ...
    static public DBElement<Key, Data> create(string name, string descr, int numChildren, int numPayload)
    {
      ...
      {
        elem.payload = new PL_String("payload  crap!!!") as Data;
      }
      return elem;
    }
  }
  ...
  class TestItemFactory
  {
    static void Main(string[] args)
    {
      ...
      DBElement<int, PL_String> elem2 = ItmFactIS.create("elem2", "test element", 3, 4);
      ...
      DBElement<string, PL_ListOfStrings> elem4 = ItmFactSL.create("elem4", "test element", 5, 6);
